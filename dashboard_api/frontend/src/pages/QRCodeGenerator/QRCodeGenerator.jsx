                ...
                >
                  {result.image_url ? (
                    <img
                      ...
                      alt="QR"
                      style={{ width: 220, height: 220, objectFit: 'contain', borderRadius: 12, backgroundColor: '#fff' }}
                    />
                  ) : result.file_url ? (
                    <img
                      src={result.file_url}
                    ...
                    <div
                      style={{ width: 220, height: 220, borderRadius: 12, backgroundColor: '#fff', overflow: 'hidden' }}
